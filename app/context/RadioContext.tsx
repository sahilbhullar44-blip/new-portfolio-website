...
const VERIFIED_PUNJABI_STATIONS: RadioStation[] = [
  ...
  },
  {
    ...
    name: "Radio Panj 24/7 (Pure Punjabi Virsa & Folk)",
    url_resolved: "http://s3.voscast.com:11264/stream",
    country: "United Kingdom",
    countrycode: "GB",
    tags: "punjabi,virsa,folk,retro,classics",
    votes: 9995,
  },
  {
    stationuuid: "pb-active-3",
    name: "Harman Radio 24/7 (100% Pure Bhangra & Punjabi)",
    url_resolved: "http://harmanradio.net:8000/channel1_HQ.mp3",
    country: "Australia",
    countrycode: "AU",
    tags: "punjabi,bhangra,dhol,desi",
    votes: 9990,
  },
  {
    stationuuid: "pb-active-4",
    name: "BritAsia Radio Punjabi 24/7 (UK Hits)",
    url_resolved: "https://s4.radio.co/sfefce156f/listen",
    country: "United Kingdom",
    countrycode: "GB",
    tags: "punjabi,pop,bhangra,uk",
    votes: 9985,
  },
  {
